...
class InfoDialog(QDialog):
    def __init__(self, parent=None):
        ...
        # Создание окна вывода (QLabel) для изображения
        ...
        #self.output_text_edit.insertPlainText("throw")
    ...
    def save_info(self, text):
        # classes = ['cartwheel', 'catch', 'clap', 'climb', 'dive', 'draw_sword', 'dribble', 'fencing', 'flic_flac', 'golf',
        #            'handstand', 'hit', 'jump', 'pick', 'pour', 'pullup', 'push', 'pushup', 'shoot_ball', 'sit', 'situp',
        #            'swing_baseball', 'sword_exercise', 'throw']
        # Получаем текст из поля output_text_edit
        # input_info = self.output_text_edit.toPlainText()
        # print(input_info)
